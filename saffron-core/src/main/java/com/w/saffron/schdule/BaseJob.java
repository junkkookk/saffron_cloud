...
import com.w.saffron.common.constant.JobEnum;
...
public abstract class BaseJob extends IJobHandler {
    ...
    public void setJob(JobEnum jobEnum){
        this.jobInfo.setJobId(jobEnum.getJobId());
        this.jobInfo.setDesc(jobEnum.getJobDesc());
    }
